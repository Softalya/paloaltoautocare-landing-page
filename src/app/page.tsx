      ...
      <div>
         ...
         <section className="relative min-h-[90vh] flex items-center pt-20">
            <div className="absolute inset-0 z-0">
               ...
               <div
                  className="w-full h-full bg-cover bg-center bg-no-repeat bg-[url('/images/palo-alto-auto-care-hero-section-image.webp')]"
            ...
            <div className="layout-container px-4 sm:px-6 lg:px-40 mx-auto max-w-7xl">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
                  <div className="relative h-64 md:h-80 rounded-xl overflow-hidden group border border-surface-border">
                     <Image
                        alt="Premium quality pre-owned vehicle"
                        className="object-cover transition-transform duration-700 group-hover:scale-105"
                        src="/images/palo-alto-auto-care-car-sales-showcase-premium-quality-image.webp"
                        fill
                  ...
                  <div className="relative h-64 md:h-80 rounded-xl overflow-hidden group border border-surface-border">
                     <Image
                        alt="Expertly inspected vehicle lineup"
                        className="object-cover transition-transform duration-700 group-hover:scale-105"
                        src="/images/palo-alto-auto-care-car-sales-showcase-expertly-inspected-image.webp"
                        fill
                        sizes="(min-width: 768px) 33vw, 100vw"
                     />
                     <div className="absolute inset-0 bg-gradient-to-t from-black via-black/10 to-transparent" />
                  ...
                  <div className="relative h-64 md:h-80 rounded-xl overflow-hidden group border border-surface-border">
                     <Image
                        alt="Mechanic approved show-ready vehicle"
                        className="object-cover transition-transform duration-700 group-hover:scale-105"
                        src="/images/palo-alto-auto-care-car-sales-showcase-mechanic-approved-image.webp"
                        fill
                        sizes="(min-width: 768px) 33vw, 100vw"
                     />
                     <div className="absolute inset-0 bg-gradient-to-t from-black via-black/10 to-transparent" />
               ...
               <div className="relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                     ...
                     <div className="flex flex-col lg:items-center lg:text-center group">
                        ...
                        <p className="text-gray-400 text-sm">Bring your car in or we pick your car up from your location.</p>
                     </div>
